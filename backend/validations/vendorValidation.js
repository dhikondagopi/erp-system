/**
 * Vendor request body validations.
 */
class VendorValidation {
  ...
  /**
   * Validate vendor attributes payload on create and update.
   */
  validateVendor(data) {
    const errors = {};

    if (!data.name || typeof data.name !== 'string' || data.name.trim() === '') {
      errors.name = 'Vendor name is required and must be a valid non-empty string.';
    }
