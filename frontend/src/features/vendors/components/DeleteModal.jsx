...
const DeleteModal = ({ isOpen, onClose, onConfirm, vendorName, vendorEmail, isDeleting }) => {
      ...
      <div className="relative w-full max-w-md rounded-2xl border border-slate-900 bg-slate-900/90 backdrop-blur-xl p-6 shadow-2xl animate-in fade-in scale-in duration-200">
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <div className="space-y-1.5">
            <h3 className="text-lg font-bold text-white">Delete Vendor profile?</h3>
            <p className="text-xs text-slate-400 max-w-sm leading-relaxed">
              Are you sure you want to delete <span className="font-semibold text-slate-200">"{vendorName}"</span> ({vendorEmail})? This action is permanent and will delete the vendor profile from the directory.
            </p>
          </div>
